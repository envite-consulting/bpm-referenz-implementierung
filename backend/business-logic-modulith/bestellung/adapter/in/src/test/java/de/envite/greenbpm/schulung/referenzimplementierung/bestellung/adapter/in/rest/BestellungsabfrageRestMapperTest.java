...
class BestellungsabfrageRestMapperTest {
  ...
  private final BestellungsabfrageRestMapper classUnderTest =
      Mappers.getMapper(BestellungsabfrageRestMapper.class);
  ...
  void should_return_null_when_source_is_null() {
    ...
    BestellungsabfrageResource result = classUnderTest.toResource(null);
