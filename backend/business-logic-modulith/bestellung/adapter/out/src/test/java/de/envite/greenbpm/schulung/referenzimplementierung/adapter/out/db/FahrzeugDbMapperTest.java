...
class FahrzeugDbMapperTest {
  ...
  class ToDb {
      ...
      void should_map_all_fields() {
          ...
          softAssertions.assertThat(result.getHersteller()).isEqualTo(fahrzeug.getHersteller().getValue());
    ...
    class ToDomain {
        ...
        void should_map_all_fields() {
            ...
            softAssertions.assertThat(result.getHersteller().getValue()).isEqualTo(entity.getHersteller());
